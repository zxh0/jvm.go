...
# Run jvm.go
Download [zulu1.8.0_31-8.5.0.1-macosx.zip](http://cdn.azulsystems.com/zulu/2015-01-8.5-bin/zulu1.8.0_31-8.5.0.1-macosx.zip) and unzip it to somewhere, Copy `jvmgo` from `$GOPATH/bin/` into unzipped folder
```sh
